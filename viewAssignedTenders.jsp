...
<body>
   ...
   <div class="col-md-8">
     ...
     <table style="border-radius:10px" >
			<tr >
				<td id="show" style="min-width:850px;background-color:white;min-height:0px;color:black">All Assigned Auctions List</td>
			</tr>
	</table>
    
    
     <table style="background-color:white; margin-left:30%;">		
     		<tr style="color:white; font-size:18px; font-weight:bold;background-color:#0087BE"> <td>Auction Id</td> <td>Vendor Id </td> 
