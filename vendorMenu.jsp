            ...
            <!-- <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="bidTender.jsp">Bid for a Auctions</a></li>
            ...
            <li>
              ...
              <form class="navbar-form hidden-xs" action="vendorSearchTender.jsp"  >
                <div class="form-group" >
                  <input type="text" class="form-control" placeholder="Find Auctions by Name or AuctionId" style="margin-left:120px;" required>
                </div>
